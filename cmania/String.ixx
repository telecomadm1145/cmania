...
export template<typename T> std::basic_string<T> Trim(const std::basic_string<T>& str, T remove = ' ') {
...
export bool EndsWith(const std::string& str, const std::string& ending) {
...
export bool StartsWith(const std::string& str, const std::string& starting) {
