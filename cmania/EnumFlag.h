...
template<typename Num, typename Num2>
constexpr inline Num ModifyFlag(Num flags, Num2 flag) {
	return (Num)((unsigned long long)flags | (unsigned long long)flag);
}
template<typename Num, typename Num2>
constexpr inline Num RemoveFlag(Num flags, Num2 flag) {
	return (Num)((unsigned long long)flags & ~(unsigned long long)flag);
}
template<typename Num, typename Num2>
constexpr inline Num ToggleFlag(Num flags, Num2 flag) {
	return (Num)((unsigned long long)flags ^ (unsigned long long)flag);
}
